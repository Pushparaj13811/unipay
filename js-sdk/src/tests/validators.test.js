...
describe('Validators', () => {
  describe('validatePaymentData', () => {
    it('should not throw for valid payment data', () => {
      ...
      expect(() => validatePaymentData('stripe', validPaymentData)).not.toThrow();
    });
    ...
    it('should throw for invalid payment data', () => {
      ...
      expect(() => validatePaymentData('stripe', invalidPaymentData)).toThrow(UniPayError);
    });
  });
  ...
  describe('validateWebhook', () => {
    ...
    it('should throw for invalid webhook data', () => {
      ...
      expect(() => validateWebhook('stripe', invalidWebhookData)).toThrow(UniPayError);
    });
  });
  ...
  describe('validateGatewayCredentials', () => {
    it('should not throw for valid Stripe credentials', () => {
      ...
      expect(() => validateGatewayCredentials('stripe', validCredentials)).not.toThrow();
    });

    it('should throw for invalid Stripe credentials', () => {
      const invalidCredentials = {};
      expect(() => validateGatewayCredentials('stripe', invalidCredentials)).toThrow(UniPayError);
    });

    it('should throw for unsupported gateway', () => {
      expect(() => validateGatewayCredentials('unsupported', {})).toThrow(UniPayError);
    });
  });
});
